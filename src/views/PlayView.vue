...
import { createNewGame, makeMove, undoMove, loadFromString, gameToString } from '@/engine_v12/model_v12';
import { findBestMove } from '@/engine_v12/engine_v12';
...
async function playerMove(r: number, c: number){
  ...
  const [compR, compC] = findBestMove(game.value, 5).bestVariation[0]
