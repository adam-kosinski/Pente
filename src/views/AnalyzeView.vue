...
const testPositions = [
  ...
  // me beating the v19 engine decisively - oops. From deeper analysis, it seems the game was basically over after move 8
...
function incrementMoveIndex() {
  ...
  analyzePosition()
  const parity = game.value.nMoves % 2 === 0 ? 1 : -1
  console.log(parity * positionFeatureDict(game.value)["momentum"])
}
