...
const testPositions = [
  ...
  // static evaluation used to be busted in this position, thought white cannot block all of black's pente threats
  // cool position though (and one move ago actually black won!)
  ...
  // no longer a bug - thinks white won, b/c misses the black move 8.14 because ordered too late, doesn't recognize that a keystone pair is being threatened - need to update move ordering to include keystone capture threats
